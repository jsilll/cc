...
assert 5 '{ int x=3; int y=5; return *(&x-8); }' # ub
assert 3 '{ int x=3; int y=5; return *(&y+8); }' # ub

assert 5 '{ int x=3; int y=&x; *y=5; return x; }'

assert 7 '{ int x=3; int y=5; *(&x-8)=7; return y; }' # ub
assert 7 '{ int x=3; int y=5; *(&y+8)=7; return x; }' # ub
